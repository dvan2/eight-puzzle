import pytest
from puzzle import Board, NotReachable

world = ("7 2 4 5 b 6 8 3 1")
b = Board(world)

def test_huristic():
   world_list = ['7', '2', '4', '5', 'b', '6', '8', '3', '1']
   assert b.calc_huristic(world_list) == 6
   world_list = ['1', '2', '3', '4', '5', '6', 'b', '7', '8']
   assert b.calc_huristic(world_list) == 2
   world_list = ['b', '1', '3', '4', '2', '5', '7', '8', '6']
   assert b.calc_huristic(world_list) == 4
   world_list = ['1', '2', '3', '4', '5', '6', '7', '8', 'b']
   assert b.calc_huristic(world_list) == 0
